...
public class ProductController {
	...
	private final List<Product> mockProducts = List.of(
			new Product("5202178009495", "E/Feta original", "Olympus", 276, 16.5, 0.7),
			new Product("4002334113032", "Der große Bauer - Kirsche", "Bauer", 366, 3.2, 12.0),
			new Product("4008452010222", "Butter", "Weihenstephan", 747, 0.6, 1.0)
	);
